...
$plugin = plugin::byId('letsencrypt');
    ...
    <div class="col-lg-2 col-md-3 col-sm-4">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
				<?php /*  <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un nom de domaine}}</a>*/?>
...
<div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <?php /*<li role="presentation"><a href="#commandtab" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> {{Commandes}}</a></li> */ ?>
  </ul>
    ...
    <form class="form-horizontal">
        <fieldset>
            <div class="form-group">
                <label class="col-sm-3 control-label">{{Nom du certificat https}}</label>
                <div class="col-sm-3">
...
<?php include_file('desktop', 'letsencrypt', 'js', 'letsencrypt');?>
